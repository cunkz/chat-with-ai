...
export default function ChatOpenAI() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await axios.post('/api/chat/openai', { message: input });
                            ...
                            <div className="pt-0">
                              <div className="gizmo-bot-avatar flex h-8 w-8 items-center justify-center overflow-hidden rounded-full">
                                <div
                                  ...
                                  <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon-md"
